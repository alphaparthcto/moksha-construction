 ...
 * Overview: stats, maintenance toggle, projects table, recent submissions, activity log.
 */
...
// ---- Data: recent activity (latest 10) ----
try {
...
<div class="page-header">
  <div>
    ...
    <p class="page-subtitle">Overview of your projects, submissions, and site status.</p>
  </div>
...
<div class="stats-grid" style="grid-template-columns:repeat(5,1fr)">
  ...
  <a href="/admin/submissions.php" class="stat-card" style="text-decoration:none;display:flex;flex-direction:column">
    ...
    <div class="stat-card-number" style="color:var(--green)"><?= (int)($subCounts['unread'] ?? 0) ?></div>
  ...
  <div class="stat-card">
    ...
    <div class="stat-card-label">Maintenance Mode</div>
  </div>
...
<!-- Two-column layout: Projects table + sidebar -->
<div style="display:grid;grid-template-columns:2fr 1fr;gap:1.5rem;align-items:start">

  <!-- LEFT: All Projects Table -->
  <div class="card">
  ...
  <div style="display:flex;flex-direction:column;gap:1.5rem">
    ...
    <!-- Card A: Recent Submissions -->
    <div class="card">
      <div class="card-header">
        <h2 class="card-title">
          New Submissions
          <?php if (($subCounts['unread'] ?? 0) > 0): ?>
            <span style="color:var(--green);font-weight:400;font-size:.8125rem;margin-left:.5rem">(<?= (int)$subCounts['unread'] ?>)</span>
          <?php endif; ?>
        </h2>
      ...
      <?php else: ?>
        <div style="display:flex;flex-direction:column">
          <?php foreach ($recentSubs as $idx => $sub):
            $sName = htmlspecialchars(($sub['first_name'] ?? '') . ' ' . ($sub['last_name'] ?? ''));
          ...
          ?>
            ...
            <a href="/admin/submissions.php"
               style="display:flex;flex-direction:column;gap:.2rem;padding:1rem 1.25rem;text-decoration:none;transition:background .15s"
               onmouseover="this.style.background='rgba(255,255,255,.03)'"
               onmouseout="this.style.background='transparent'">
              <div style="display:flex;align-items:center;justify-content:space-between;gap:.5rem">
                <span style="font-size:.875rem;font-weight:500;color:var(--text-1)"><?= $sName ?></span>
                <span style="font-size:.75rem;color:var(--text-3);white-space:nowrap"><?= $sTime ?></span>
              </div>
              <?php if ($sType): ?>
